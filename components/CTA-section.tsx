        ...
        <div className="relative mb-8">
          <div className="flex items-center justify-center">
            ...
            <div className="text-center px-8">
              <h2 className="text-5xl md:text-5xl font-bold mb-3 text-darkblue">Join Our <span className="text-[#00A5E0]">Mission</span></h2>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            ...
            >
              <Link
                href="/donor/signup"
                className="inline-flex items-center  bg-gradient-to-r from-[#1f0379] to-[#00A5E0] hover:opacity-90 text-white px-6 py-2 rounded-full font-semibold transition-all duration-300 shadow-lg hover:shadow-xl text-sm group"
              >
                Get Involved
                <motion.div
                  className="ml-2"
